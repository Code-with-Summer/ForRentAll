...
export default function AdminCreateBlog(){
  ...
  const [toolbarState, setToolbarState] = useState({ bold: false, italic: false, underline: false, fontSize: false, blockquote: false, alignLeft: false, alignCenter: false, alignRight: false });
        ...
        <div className="bc-content">
          <div className="bc-block">
            <div className="bc-toolbar">
              ...
              />
              <button type="button" title="Blockquote" className={toolbarState.blockquote ? "active" : ""} onClick={toggleBlockquote}>"</button>
