...
export default function Ticket() {
  ...
  return (
    <div className="page-container mobile-links-page" style={{ maxWidth: 700, padding: 32 }}>
      <div style={{ display: "flex", gap: 18, marginBottom: 24 }}>
        <button
          style={{ background: view === "view" ? "#d4a017" : "#fff3cf", color: "#1f2937", border: "1px solid #c28e14", borderRadius: 6, padding: "10px 28px", fontWeight: 600, cursor: "pointer" }}
          onClick={() => setView("view")}
        >
          View All Tickets
        </button>
        <button
          style={{ background: view === "raise" ? "#d4a017" : "#fff3cf", color: "#1f2937", border: "1px solid #c28e14", borderRadius: 6, padding: "10px 28px", fontWeight: 600, cursor: "pointer" }}
      ...
      {view === "view" ? (
        ...
        <form onSubmit={handleSubmit} style={{ maxWidth: 420, margin: "0 auto" }}>
          <h2 style={{ color: "#1f2937", marginBottom: 18 }}>Raise a Ticket</h2>
          ...
          <button
            type="submit"
            disabled={submitting}
            style={{ background: "#d4a017", color: "#1f2937", border: "1px solid #c28e14", borderRadius: 6, padding: "10px 28px", fontWeight: 600, cursor: "pointer", width: "100%" }}
          >
