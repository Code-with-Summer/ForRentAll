          ...
          >
            ...
            {selectedInvoice.screenshot && (
              <div style={{ marginTop: 12 }}>
                ...
                <br />
                <img
                  src={selectedInvoice.screenshot}
          ...
          <div className="dash-content">
            ...
            <div className="dash-section" style={{ marginTop: "2rem" }}>
              ...
              <div className="dash-stat-card">
                ...
                <div>
                  <p className="dash-stat-value">
                    {propsList.reduce((acc, p) => acc + (p.units?.filter(u => u.tenant)?.length || 0), 0)}
                  </p>
                  <p className="dash-stat-label">Total Tenants</p>
                </div>
              </div>
                <button
                  style={{
            ...
            <div className="dash-section" style={{ marginTop: "2rem" }}>
              ...
              >
                <p>
                  View and manage maintenance requests/issues for your
                  properties here.
                </p>
                <button
                  style={{
