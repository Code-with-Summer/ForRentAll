  ...
  return (
    <div className="page-container mobile-links-page">
      <div className="page-header">
        ...
        <div className="my-properties-filter-row">
          <label className="my-properties-filter-label">Filter:</label>
          <select className="my-properties-filter-select" value={filter} onChange={e => setFilter(e.target.value)}>
            <option value="none">All</option>
            <option value="vacant">Vacant</option>
            <option value="occupied">Occupied</option>
          </select>
          {filter !== "none" && (
            <button className="my-properties-filter-clear" onClick={() => setFilter("none")}>Remove Filter</button>
          )}
        </div>
      </div>
      ...
      {!filteredData.length ? (
        <div className="empty-state">
          ...
          <button className="create-prop-button" onClick={() => nav('/property/create')}>
            + Create Property
          </button>
        </div>
      ) : (
